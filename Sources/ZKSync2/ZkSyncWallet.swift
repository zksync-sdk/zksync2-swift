...
//        let estimate: Transaction = Transaction.createFunctionCallTransaction(from: signer.address,
//                                                                              to: txTo,
//                                                                              ergsPrice: BigInt.zero,
//                                                                              ergsLimit: BigInt.zero,
//                                                                              value: txAmount,
//                                                                              data: ABIEncoder.encodeSingleType(type: .function, value: <#T##AnyObject#>))
    }
