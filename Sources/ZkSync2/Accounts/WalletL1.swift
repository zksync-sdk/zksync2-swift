...
extension WalletL1 {
    ...
    func isWithdrawalFinalized(withdrawHash: String, index: Int = 0) async -> Bool {
...
extension WalletL1 {
    ...
    public func estimateRequestExecute(transaction: CodableTransaction) async throws -> BigUInt?{
        return try! await ethClient.estimateGas(transaction)
    }
    
    public func estimateRequestExecute(transaction: RequestExecuteTransaction) async throws -> BigUInt?{
